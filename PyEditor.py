...
class MainWindow(wx.Frame):
    def __init__(self, parent, title):
        ...
        menuSave = filemenu.Append(wx.ID_SAVE, "&Save", " Save your current file")
        ...
        menuRedo = editmenu.Append(wx.ID_REDO, "&Undo", " Redo last action")
        editmenu.AppendSeparator()
        menuSelectAll = editmenu.Append(wx.ID_SELECTALL, "Select &All", " Select the entire file")
        ...
        helpmenu = wx.Menu()
        menuHowTo = helpmenu.Append(wx.ID_ANY, "&How To...", " Get help on using the editor")
    ...
    def OnOpen(self, e):
        try:
            dlg = wx.FileDialog(self, "Open a file...", self.dirname, "", "*.*", wx.FD_OPEN)
            ...
            dlg = wx.MessageDialog(self, "Could not open file", "Error", wx.ICON_ERROR)
            dlg.ShowModal()
            dlg.Destroy()
